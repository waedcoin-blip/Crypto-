...
import { createRoleConnection } from './roleConnectionFactory';
...
export class WalletBalanceService {
  ...
  constructor(network: TradingNetwork = 'paper') {
    ...
    this.connection = network === 'paper' ? null : createRoleConnection('monitor');
  ...
  public updateNetwork(network: TradingNetwork): void {
    ...
    this.connection = createRoleConnection('monitor');
    useBalanceStore.getState().setNetwork(network);
    void this.refresh();
  }
